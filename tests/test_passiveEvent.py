...
class Test_PassiveEvent(TestCase):
    ...
    def test_noColide(self):
        self.status.CatchValue(passiveEvent.ReactionState.InAir, Rect(128 - 8, 256 - 16 - 24, 16, 24))
    ...
    def test_existTopColide(self):
        self.status.CatchValue(passiveEvent.ReactionState.InAir, Rect(128 - 8, 224, 16, 24))
        terrObjs:list[Rect] = []
        for x in range(1, 17):
